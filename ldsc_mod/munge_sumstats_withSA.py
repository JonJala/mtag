...
def filter_alleles(a):
    ...
    if incl_strand_ambiguous:
        filter_flag = a.isin(sumstats_withSA.VALID_SNPS_STR_AMBIG)
    else:
        filter_flag = a.isin(sumstats_withSA.VALID_SNPS)
...
def allele_merge(dat, alleles):
    ...
    match = a1234.apply(lambda y: y in sumstats_withSA.MATCH_ALLELES)
